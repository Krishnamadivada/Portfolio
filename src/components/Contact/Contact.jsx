...
const contactDetails = [
    {id : 1, icon: <PhoneOutlined />, details: '9381591620'},
    {id : 2, icon: <MailOutlined />, details: 'mkvamsi999@gmail.com'},
    {id : 3, icon: <EnvironmentOutlined />, details: 'Hyderabad, Telangana'}
]
...
const onFinish = (values) => {
  ...
  const templateParams = {
    to_name: 'Krishna Vamsi',
    from_name: values.name,
    message: values.message,
    reply_to: values.email,
  };

  emailjs.send('service_an4pd1w', 'template_aqlg9r5', templateParams, 'N4yXATbDfrYz4OqtC')
    .then((response) => {
