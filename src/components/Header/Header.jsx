  ...
  return (
      ...
      <img className='logo' src={Logo} alt="MKV" />
        <div className='desktopMenu'>
          ...
          <Link activeClass='active' to='project' spy={true} smooth={true} offset={-35} duration={500} className="desktopMenuItem">Projects</Link>
          <Link activeClass='active' to='skills' spy={true} smooth={true} offset={-5} duration={500} className="desktopMenuItem">Skills</Link>
          <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-4} duration={500} className="desktopMenuItem">Contact Me</Link>
        </div>
        ...
        <div className='mobileMenu' style={{display: showMenuItem? 'flex' : 'none'}}>
          ...
          <Link activeClass='active' to='project' spy={true} smooth={true} offset={-100} duration={500} className="mobileMenuItem" onClick={() => setShowMenuItem(false)}>Projects</Link>
